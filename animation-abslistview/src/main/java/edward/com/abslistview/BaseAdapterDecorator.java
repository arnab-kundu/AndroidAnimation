...
import edward.com.abslistview.util.ListViewWrapperSetter;
import edward.com.abslistview.util.Swappable;

/**
 * A decorator class that enables decoration of an instance of the {@link android.widget.BaseAdapter} class.
 * <p/>
...
public abstract class BaseAdapterDecorator extends BaseAdapter implements SectionIndexer, Swappable, Insertable, ListViewWrapperSetter {
    ...
    /**
     * The {@link edward.com.abslistview.util.ListViewWrapper} containing the ListView this {@code BaseAdapterDecorator} will be bound to.
     */
    @Nullable
    ...
    /**
     * Returns the {@link edward.com.abslistview.util.ListViewWrapper} containing the ListView this {@code BaseAdapterDecorator} is bound to.
     */
    @Nullable
    ...
    /**
     * Alternative to {@link #setAbsListView(android.widget.AbsListView)}. Sets the {@link edward.com.abslistview.util.ListViewWrapper} which contains the ListView
